			    ...
			    <div class="col-md-12">
                    <div class="panel panel-topborder-green">
                        <div class="panel-heading">
                            ...
                            <h4 class="panel-title"><b>IBYACURUJWE</b></h4>
                        </div>
                        <div class="panel-body">
                        	...
                        	<div id="tablespace">
	                            <table id="data-table" class="table table-striped table-bordered table-condensed">
	                                ...
	                                <tbody>
	                                <?php  
	                                	$selectedtrans = $db->query("SELECT * FROM `outtransactions` ORDER BY `trId` DESC");
	                                	$n=1;
			                        	$loan = 0;
			                        	$paid = 0;
	                            ...
	                            <div class="small-modal">
	                            	<div class="btn btn-curve bg-blue text-white form-control">Ayacurujwe  : <?php echo number_format($loan + $paid); ?> Rwf</div>
